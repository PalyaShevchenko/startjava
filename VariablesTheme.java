public class VariablesTheme {
    ...
    public static void main(String[] args) {
        ...
        discount = (pricePen + priceBook) / 100 * percentDiscount;
        purchaseAmount = pricePen + priceBook - discount;
        System.out.println("сумма скидки " + discount + "руб");
        System.out.println("общая стоимость товаров со скидкой " + purchaseAmount + "руб");
        ...
        System.out.println("исходные значения переменных: num3 = " + num3 + ",   num5 = " + num5);
        num6 = num3;
        num3 = num5;
        num5 = num6;
        System.out.println("новые значения переменных:    num3 = " + num3 + ",   num5 = " + num5);
        ...
        int multiplDigit;
        num = 345;
        multiplDigit = (num / 100) * (num / 10 % 10) * (num % 10);
        sumDigit = num / 100 + num / 10 % 10 + num % 10;
        System.out.println("сумма цифр числа " + num +" = " + sumDigit);
        System.out.println("произведение цифр числа " + num + " = " + multiplDigit);
